package com.example.jsonrestservicedemo;
...
*/
    ...
    public class JsonAsync extends AsyncTask<Void, Void, StringBuilder>
    {
		...
		protected StringBuilder doInBackground(Void... params) 
		{
			...
			System.out.println("https://maps.googleapis.com/maps/api/distancematrix/json?origins="+ed1.getText()+"&destinations="+ ed2.getText()+"&mode=driving&sensor=false");
			
			HttpGet httpGet = new HttpGet("https://maps.googleapis.com/maps/api/distancematrix/json?origins="+ed1.getText()+"&destinations="+ ed2.getText()+"&mode=driving&sensor=false");
